...
public class Main {
    public static void main(String[] args) {
        ...
        shop.addProduct(new Phone("Nokia-g10", 10_000, "Nokia"))
                ...
                .addProduct(new Phone("Samsung-s21", 20_000, "Samsung"))
                .addProduct(new Toy("Car", 1_000, 3))
                .addProduct(new Toy("Barby", 1_400, 3))
                .addProduct(new Food("Cheese", 400, new GregorianCalendar(2023, Calendar.JANUARY, 12)))
                .addProduct(new Food("Sausage", 600, new GregorianCalendar(2023, Calendar.JANUARY, 2)))
                .addProduct( new Food("Fish", 500, new GregorianCalendar(2022, Calendar.DECEMBER, 25)))
                .addProduct(new Food("Milk", 50, 2023, 1, 5));
        System.out.println("Shop: " + shop);
        System.out.println("Size = "+ shop.size());
        shop.deleteProduct("Samsung-s21");
        System.out.println("Shop: " + shop);
        System.out.println("Size = "+ shop.size());
